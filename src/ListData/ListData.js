...
class ListData extends React.Component {
  constructor() {
    ...
    if (localStorage.getItem("userDetails")) {
      this.state.myDetails = JSON.parse(localStorage.getItem("userDetails"));
    }
  ...
  deleteItem = (listIndex) => {
    ...
    localStorage.setItem("userDetails", JSON.stringify(myList));
  };
  ...
  onAddList(name, age) {
    ...
    if (formIsValid) {
      ...
      localStorage.setItem("userDetails", JSON.stringify(myDetails));
    }
  }
      ...
      <div className="listdata">
        <div className="list_heading">
          ...
          <div className="add_btn">
            <button onClick={this.AddListBtn} className="btn medium">
              ADD
            </button>
          </div>
